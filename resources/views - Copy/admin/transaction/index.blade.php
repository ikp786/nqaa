...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">All Transaction</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">All Transaction</h6>
    </nav>
@endsection
    ...
    <div class="row">
        <div class="col-12">
         ...
         <div style="padding: 20px; ">
            <h6>Transactions will be display here once Payment gateway and API's integrated. </h6>
         </div>
            </div>
        </div>
    </div>
