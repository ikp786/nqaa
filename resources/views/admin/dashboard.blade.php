...
@section('breadcrumb')
    ...
    <nav aria-label="breadcrumb">
        ...
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">NAQAA</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    ...
                                    <div class="numbers">
                                        ...
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Merchant</p>
