    ...
    <div class="modal fade" id="modal-create">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="add_form" method="POST" autocomplete="off" action="{{ route('admin.orders.sent_whatsapp_message') }}" >
                    @csrf
                    <input type="hidden" name="order_id" id="order_id" />
                    <div class="modal-header">
                        <h4 id="form_title" class="modal-title">Order Sent Whatsapp</h4>
     ...
     <div class="modal fade" id="product_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 id="form_title" class="modal-title">Order Detail</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click','.product_show',function(){                
                ...
                $.ajax({
                            url: "{{ route('admin.orders.get_order_product') }}",
                            type: "POST",
                            dataType: "json",
                            data: {
                                id: id,
            ...
            const updateStatus = '{{ route('admin.orders.status') }}';
            $('#datatable').on('change', 'tbody select.status', function() {
                var status = $(this).val();
                var id = $(this).data('id');
